...
public class ComplexOperationsTest {
    ...
    /**
     * Test of complexSum method, of class ComplexOperations.
     */
    @Test
    public void testComplexSum() {
        System.out.println("Test of complexSum method, of class ComplexOperations.");
    ...
    /**
     * Test of complexSub method, of class ComplexOperations.
     */
    @Test
    public void testComplexSub() {
        System.out.println("Test of complexSub method, of class ComplexOperations.");
    ...
    /**
     * Test of complexProd method, of class ComplexOperations.
     */
    @Test
    public void testComplexProd() {
        System.out.println("Test of complexProd method, of class ComplexOperations.");
    ...
    /**
     * Test of complexDiv method, of class ComplexOperations.
     */
    @Test
    public void testComplexDiv() {
        System.out.println("Test of complexDiv method, of class ComplexOperations.");
    ...
    public void testSqrt() {
        System.out.println("Test of sqrt method, of class ComplexOperations.");
    ...
    @Test
    public void testMod() {
        System.out.println("Test of mod method, of class ComplexOperations.");
    ...
    @Test
    public void testArg() {
        System.out.println("Test of arg method, of class ComplexOperations.");
    ...
    /**
     * Test of exp method, of class ComplexOperations.
     */
    @Test
    public void testExp() {
        System.out.println("Test of exp method, of class ComplexOperations.");
    ...
    /**
     * Test of log method, of class ComplexOperations.
     */
    @Test
    public void testLog() throws OperationDenied {
        System.out.println("Test of log method, of class ComplexOperations.");
    ...
    /**
     * Test of log method, of class ComplexOperations, when it launches
     * OperationDenied.
     */
    @Test(expected = OperationDenied.class)
    public void testLog2() throws OperationDenied {
        System.out.println("Test of log method, of class ComplexOperations, when it launches OperationDenied.");

        ComplexOperations.log(new Complex(0.0, 0.0));
    }

    /**
     * Test of sin method, of class ComplexOperations.
     */
    @Test
    public void testSin() {
        System.out.println("Test of sin method, of class ComplexOperations.");
    ...
    /**
     * Test of cos method, of class ComplexOperations.
     */
    @Test
    public void testCos() {
        System.out.println("Test of cos method, of class ComplexOperations.");
    ...
    /**
     * Test of tan method, of class ComplexOperations.
     */
    @Test
    public void testTan() throws OperationDenied {
        System.out.println("Test of tan method, of class ComplexOperations.");
    ...
    /**
     * Test of pow method, of class ComplexOperations.
     */
    @Test
    public void testPow() throws OperationDenied {
        System.out.println("Test of pow method, of class ComplexOperations.");
    ...
    /**
     * Test of pow method, of class Complex, when it throws an OperationDenied.
     */
    @Test(expected = OperationDenied.class)
    public void testPow2() throws OperationDenied {
        System.out.println("Test of pow method, of class Complex.");
     ...
     */
    @Test
    public void testArctan() throws OperationDenied {
        System.out.println("Test of arctan method, of class ComplexOperations.");

        //This case is used to test that the arc tangent of a number with
        //positive real part and imaginary part 
        assertEquals(new Complex(1.4701378, 0.0993254), ComplexOperations.arctan(new Complex(5.0, 5.0)));

        //This case is used to test that the arc tangent of a number with
        //negative real part and imaginary part 
        assertEquals(new Complex(-1.4701378, -0.0993254), ComplexOperations.arctan(new Complex(-5.0, -5.0)));

        //This case is used to test that the arc tangent of a number with
        //positive real part and imaginary part equal to zero
        assertEquals(new Complex(1.3734008, 0.0), ComplexOperations.arctan(new Complex(5.0, 0.0)));

        //This case is used to test that the arc tangent of a number with
        //positive imaginarypart and real  part equal to zero
        assertEquals(new Complex(1.5707963, 0.2027326), ComplexOperations.arctan(new Complex(0.0, 5.0)));

        //This case is used to test that the arc tangent of a number with
        //negative real part and imaginary part equal to zero
        assertEquals(new Complex(-1.3734008, 0.0), ComplexOperations.arctan(new Complex(-5.0, 0.0)));

        //This case is used to test that the arc tangent of a number with
        //negative imaginarypart and real  part equal to zero
        assertEquals(new Complex(1.5707963, -0.2027326), ComplexOperations.arctan(new Complex(0.0, -5.0)));
