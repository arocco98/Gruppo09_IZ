...
public class ArcsinCommandTest {
    ...
    public void testExecute() throws Exception {
        System.out.println("Test of execute method, of class ArcsinCommand.");
    ...
    /**
     * Test of execute method, of class ArcsinCommand, when it throws a
     * StackSizeException.
     */
    @Test(expected = StackSizeException.class)
    public void testExecuteWhenThrowsException() throws Exception {
        System.out.println("Test of execute method, of class ArcsinCommand, when it throws a StackSizeException.");
