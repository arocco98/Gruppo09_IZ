...
public class TanCommandTest {
    ...
    public void testExecute() throws StackSizeException, OperationDenied {
        System.out.println("Test of execute method, of class TanCommand.");
    ...
    /**
     * Test of execute method, of class TanCommand, when it throws a
     * StackSizeException.
     */
    @Test(expected = StackSizeException.class)
    public void testExecute2() throws StackSizeException, OperationDenied {
        System.out.println("Test of execute method, of class TanCommand, when it throws a StackSizeException.");
