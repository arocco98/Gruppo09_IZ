...
public class SubCommandTest {
    ...
    public void testExecute1() throws StackSizeException {
        System.out.println("Test of execute method with a stack size smaller than 2, of class SubCommand.");
    ...
    public void testExecute2() throws StackSizeException {
        System.out.println("Test of execute method with a stack size greater than 2 or equal, of class SubCommand.");
        stack.push(c1);
        stack.push(c2);
        SubCommand instance = new SubCommand(stack);
        instance.execute();
